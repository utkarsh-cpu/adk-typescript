...
import { BaseAgentConfig, ParallelAgentConfig } from "./configs";
import { InvocationContext } from "./invocation-context";

function _createBranchCtxForSubAgent(agent: BaseAgent, subAgent: BaseAgent, invocationContext: InvocationContext): InvocationContext {
 ...
 */
async function* _mergeAgentRun(agentRuns: AsyncGenerator<Event>[]): AsyncGenerator<Event> {
