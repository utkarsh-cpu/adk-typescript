### IN BUILDING STAGE, MOST OF THE FUNCTIONALITY IS PORTED NOW FROM PYTHON, BUT REACT NATIVE COMPONENTS ARE IN STILL NEEDED TO BE WORKED ON, AND BASICALLY TEST EXAMPLES WOULD BE WRITTEN
